...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='category',
            name='department',
            field=models.ForeignKey(help_text='Department where this category of products is made', on_delete=django.db.models.deletion.CASCADE, to='products.department'),
        ),
        migrations.CreateModel(
            name='AttributeValue',
            fields=[
